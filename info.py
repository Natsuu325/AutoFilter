...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1001541862736') # support group id ( make sure bot is admin )
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1001541862736') # request channel id ( make sure bot is admin )
...
HOWTOVERIFY = environ.get('HOWTOVERIFY', 'https://t.me/how_to_download_tut/6') # How to open tutorial link for verification
