...
OWNER_ID = environ.get('OWNER_ID', '1269717144')
...
OWNER_USERNAME = environ.get('OWNER_USERNAME', 'NatsuSenpai') # owner username without @

# Admins, Channels & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '1698949521 6142822474').split()]
...
PREMIUM_USER = [int(user) if id_pattern.search(user) else user for user in environ.get('PREMIUM_USER', '1698949521').split()]
...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1002007633784') # support group id ( make sure bot is admin )
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1002007633784') # request channel id ( make sure bot is admin )
...
TEXT = environ.get("APPROVED_WELCOME_TEXT", "<b>{mention},\n\nʏᴏᴜʀ ʀᴇǫᴜᴇsᴛ ᴛᴏ ᴊᴏɪɴ {title} ɪs ᴀᴘᴘʀᴏᴠᴇᴅ.\n\‣ ᴘᴏᴡᴇʀᴇᴅ ʙʏ @kdrama_time</b>")
APPROVED = environ.get("APPROVED_WELCOME", "on").lower()

# Verify
VERIFY = bool(environ.get('VERIFY', False)) # Verification On ( True ) / Off ( False )
HOWTOVERIFY = environ.get('HOWTOVERIFY', 'https://t.me/how_to_download_tut/4') # How to open tutorial link for verification
...
BOT_USERNAME = environ.get("BOT_USERNAME", "Kdt_FilesBot")
BOT_NAME = environ.get("BOT_NAME", "Kdt files")
BOT_ID = environ.get("BOT_ID", "7190723078")
S_GROUP = environ.get('S_GROUP', "Kdrama Time Chat")
S_CHANNEL = environ.get('S_CHANNEL', "Kdrama Time")
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/kdrama_times_chat')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/kdrama_time')
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/how_to_download_tut/4') # Tutorial video link for opening shortlink website 
IS_TUTORIAL = bool(environ.get('IS_TUTORIAL', True))
MSG_ALRT = environ.get('MSG_ALRT', 'ᴍᴀɪɴᴛᴀɪɴᴇᴅ ʙʏ : Kdrama Time')
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002146580509')) #Log channel id ( make sure bot is admin )
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/+tZp6sXORvl5kMjM1') #Support group link ( make sure bot is admin )
